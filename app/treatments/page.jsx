...
const Treatments = () => {
  ...
  return (
    <motion.section initial={{ opacity: 0 }} animate={{ opacity: 1, transition: { delay: 2 } }} className="min-h-screen flex items-center overflow-x-hidden">
      <div className="container mx-auto flex items-center pt-48 pb-12 xl:pt-48 xl:pb-0">
        <div className='w-full h-full flex items-center justify-between'>
          ...
          className='flex flex-col items-start xl:max-w-[650px] text-center xl:text-left mx-auto'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-[20px] mb-14 mx-auto xl:mx-0'>
              <div className='flex-1 flex flex-col justify-center items-center xl:items-start'>
                ...
                </div><p className='pl-6 text-[15px]'>Deep cleansing, exfoliation and hydration for a refreshed complextion</p>
              </div>
              {/* end items  */}
              <div className='flex-1 flex flex-col justify-center items-center xl:items-start'>
                <div className="flex items-center gap-[12px] mb-2">
                ...
                </div><p className='pl-6 text-[15px]'>Exfoliationg treatment to improve skin texture and tone</p>
              </div>
              {/* end items  */}
              <div className='flex-1 flex flex-col justify-center items-center xl:items-start'>
                <div className="flex items-center gap-[12px] mb-2">
              ...
              <div className='flex-1 flex flex-col justify-center items-center xl:items-start'>
                ...
                </div><p className='pl-6 text-[15px]'>Multi-step treatment for instant hydration and glow </p>
              </div>
              {/* end items  */}
            </div>
            {/* btn */}
          ...
          className='hidden xl:flex w-[384px] h-[534px] relative'>
            <Image src="/assets/treatments/img.jpg" fill alt="" quality={100} priority className="object-contain" />
          </motion.div>
        </div>
